<x-app-layout>
    ...
    <div class="py-8 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        @else
            <div class="bg-white shadow-sm rounded-xl border border-gray-100 p-6 sm:p-8">
                <p class="text-xs font-semibold uppercase tracking-wider text-gray-400 mb-4">Account Management</p>
                <div class="flex items-start gap-4">
                    ...
                    <div class="flex-1">
                        <p class="text-sm text-gray-700">Deleting, disabling, or suspending an account is handled by an administrator to keep account changes secure and auditable.</p>
                        <p class="text-sm text-gray-500 mt-1.5">Need your account closed or temporarily disabled? Reach out to your IT administrator.</p>
                    </div>
                </div>
            </div>
        @endif
